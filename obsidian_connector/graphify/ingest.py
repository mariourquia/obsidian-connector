...
from obsidian_connector.graphify.security import safe_fetch, safe_fetch_text, validate_url
...
def ingest(url: str, target_dir: Path, author: str | None = None, contributor: str | None = None) -> Path:
    ...
    try:
        ...
        if url_type == "youtube":
            from obsidian_connector.graphify.transcribe import download_audio
