...
from obsidian_connector.graphify.detect import CODE_EXTENSIONS, DOC_EXTENSIONS, PAPER_EXTENSIONS, IMAGE_EXTENSIONS
...
def _rebuild_code(watch_path: Path, *, follow_symlinks: bool = False) -> bool:
    ...
    try:
        ...
        from obsidian_connector.graphify.detect import detect
        from obsidian_connector.graphify.build import build_from_json
        from obsidian_connector.graphify.cluster import cluster, score_all
        from obsidian_connector.graphify.analyze import god_nodes, surprising_connections, suggest_questions
