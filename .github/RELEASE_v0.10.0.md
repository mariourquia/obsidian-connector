...
| |_| | |_) \__ \ | (_| | | (_| | | | / /__| (_) | | | | | | |  __/ || (_) | |
 \___/|_.__/|___/_|\__,_|_|\__,_|_| |_\____/\___/|_| |_|_| |_|\___|\__\___/|_|
                ...
                v0.10.0 -- Cross-Device Sync + Shared Vaults + CI Health
...
(`mcpb.json`), and package metadata (`pyproject.toml`) are all at 0.10.0.
...
- **No breaking changes.** All v0.9.0 tool signatures, CLI flags, MCP schemas,
  ...
  (`device_label`, `platform`, `app_version`) are optional; pre-v0.10.0
  payloads continue to work.
- **Capture-service requirement**: this version talks to obsidian-capture-service
  v0.10.0. For the new `obsidian_mobile_devices` / `obsidian_forget_mobile_device`
...
- Service companion: `obsidian-capture-service` v0.10.0 (same release wave)
